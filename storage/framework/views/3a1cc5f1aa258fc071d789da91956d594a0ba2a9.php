                    ...
                    <div class="col-md-12 ">   
                        <form  class="form-horizontal" role="form" method="post" action="<?php echo e(route('login')); ?>">
                                ...
                                <div class="form-group">
                                    <input id="login-username" type="text" class="form-control" name="email" value="<?php echo e(old('email')); ?>" placeholder="User ID" required>   
                                    <?php if($errors->has('user_id')): ?>  
                                        <span class="error"><strong><?php echo e($errors->first('user_id')); ?></strong></span>
                                    <?php endif; ?>               
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <?php if($errors->has('password')): ?>  
                                            <span class="error"><strong><?php echo e($errors->first('password')); ?></strong></span>
                                    <?php endif; ?> 
                                </div>
