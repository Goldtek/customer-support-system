                                                        ...
                                                        <div class="btn-group">
                                                            ...
                                                            <ul class="dropdown-menu pull-left" role="menu">
                                                                <li>
                                                                    ...
                                                                    <a href="javascript:;" onclick="user()" data-tooltip="true" data-placement="top" data-target=".user" data-email="{{$client->email}}"  data-company="{{$client->company}}"  data-firstname="{{$client->firstname}}" data-lastname="{{$client->lastname}}" data-phone="{{$client->phone}}" data-id="{{$client->id}}"  data-toggle="modal" title="Edit Client">
    ...
    <div class="modal fade" id="user" tabindex="-1" role="dialog" aria-labelledby="edit" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">               	        
                <form class="form-vertical" method="post" action="{{route('create_clients')}}" id="createForm">
